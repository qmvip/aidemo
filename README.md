...
# V5任务拆分
curl -X POST http://82.156.189.26:9988/api/distributed/v5/split \
  -H "Content-Type: application/json" \
  -d '{"question":"什么是真正的理解？"}'
# V5融合
curl -X POST http://82.156.189.26:9988/api/distributed/v5/fuse \
  -H "Content-Type: application/json" \
  -d '{"results":["哲学回答","科学回答","技术回答"],"scores":[0.9,0.8,0.85],"method":"power"}'
```
## API文档
- [客户对接指南](./docs/customer_onboarding.md)
- [节点加入指南](./docs/node_join_guide.md)
- [技术设计文档](./docs/wangyi_ai_blockchain_design.md)
## 架构图
```
┌─────────────────────────────────────────────────────────────┐
│                      望易AI区块链                          │
